  ...
  return (<>
    ...
    <Box class='profile-button'>
      ...
      {isLoading ?
        ...
        : val ? <Box sx={{ marginTop: '20px', marginLeft: '580px', width: '500px', display: { xs: 'none', sm: 'block' } }}><Button class='place-order' onClick={() => sendOrder(total)}>PLACE ORDER</Button></Box>
          : <Box sx={{ marginTop: '20px', marginLeft: '580px', width: '500px', display: { xs: 'none', sm: 'block' } }}><Button class='place-unorder' disabled={true}>PLACE ORDER</Button></Box>}
      {isLoading ?
        <div>
          <Box sx={{ marginTop: '70px', marginLeft: '400px' }}>
            <CartSkeleton />
        ...
        : val ? <Box sx={{ marginTop: '20px', width: '500px', display: { xs: 'block', sm: 'none' } }}><Button class='place-order' onClick={() => sendOrder(total)}>PLACE ORDER</Button></Box>
          : <Box sx={{ marginTop: '20px', width: '500px', display: { xs: 'block', sm: 'none' } }}><Button class='place-unorder'>PLACE ORDER</Button></Box>}
    </Box>
  </>)
}
